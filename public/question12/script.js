document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveSelectedMinors() {
        ...
        localStorage.setItem('religion', JSON.stringify(finalSelection));
        console.log("religion:", finalSelection);
    }
...
function skip() {
    location.href = "/question13"
    localStorage.setItem('religion',"none")
}